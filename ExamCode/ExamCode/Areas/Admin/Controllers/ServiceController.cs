...
namespace ExamCode.Areas.Admin.Controllers
{
    ...
    public class ServiceController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Icon,Subtitle,Title,Text,Id")] Service service)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Icon,Subtitle,Title,Text,Id")] Service service)
        {
            if (id != service.Id)
            {
                return NotFound();
